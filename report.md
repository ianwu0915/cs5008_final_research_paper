...
After checking that our implementation is correct, there might be some possible reasons that we observe a linear time complexity.
...
Overall, further research are required to an more accurate interpretation of our result .
...
The advantages of using a MaxHeap data structure include:
